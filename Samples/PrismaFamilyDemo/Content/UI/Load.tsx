...
export default (
  <Scene name="Prisma Family Load" width={1280} height={720}
    theme={[
    ...
    <Group name="LoadRoot"
      ...
      accessibilityLabel="讀檔畫面" accessibilityRole="dialog" accessibilityFocusOrder={0}>
      <Text name="LoadTitle"
        layout={at(68, 46, 700, 58)} text="回到那一刻  /  LOAD"
        appearance={{backgroundColor: "#00000000", textColor: "#FFF4F2FF", opacity: 1, styleToken: "paperText"}}
        runtimeProperties={{fontSize: 36}} accessibilityLabel="讀檔"
      ...
      <Grid name="Slots"
        ...
        accessibilityLabel="讀檔欄位" accessibilityRole="grid" accessibilityFocusOrder={10} />
      <OverlayCloseButton label="關閉讀檔畫面" />
    </Group>
  </Scene>
);
