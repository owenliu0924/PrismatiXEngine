...
# Lua intentionally uses the upstream source set instead of a browser-side
# interpreter or JavaScript shim.
FetchContent_Declare(
    lua
...
list(TRANSFORM PRISMATIX_LUA_SOURCES PREPEND "${lua_SOURCE_DIR}/")
add_library(prismatix_lua STATIC ${PRISMATIX_LUA_SOURCES})
add_library(Lua::Lua ALIAS prismatix_lua)
target_compile_features(prismatix_lua PRIVATE c_std_99)
target_include_directories(prismatix_lua PUBLIC "${lua_SOURCE_DIR}")
set(LUA_INCLUDE_DIR "${lua_SOURCE_DIR}")
set(LUA_LIBRARIES prismatix_lua)
