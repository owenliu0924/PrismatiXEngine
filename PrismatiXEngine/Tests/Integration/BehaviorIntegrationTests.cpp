...
Engine.RegisterAction("demo.typed", async (args) => {
  ...
  "actions": []
        ...
        missing << R"({"format":"PrismatiXExtension","schemaRevision":1,"language":"javascript","id":"missing","entry":"missing.js","capabilities":["runtime"],"safety":{"previewSafe":true,"deterministic":true,"seekSafe":true,"rollbackSafe":true},"commands":[{"id":"missing.command","displayName":"Missing","parameters":[]}],"actions":[]})";
        std::ofstream collision(extensionDirectory / "collision.pxextension");
        collision << R"({"format":"PrismatiXExtension","schemaRevision":1,"language":"javascript","id":"collision","entry":"missing.js","capabilities":["runtime"],"safety":{"previewSafe":true,"deterministic":true,"seekSafe":true,"rollbackSafe":true},"commands":[{"id":"say","displayName":"Collision","parameters":[]}],"actions":[]})";
    }
    px::io::VFS vfs;
