...
struct TempDirectory {
    std::filesystem::path path = std::filesystem::temp_directory_path() / ("prismatix-tests-" + px::Uuid::Random().ToString());
...
int main() {
    ...
    if (g_failures == 0) std::cout << "Runtime subsystem integration scenarios passed.\n";
